 ...
 * @param elementType
 */
function countChildrenByType(element: Element, elementType: string): number {
 ...
 */
export default function rehypeRicherFigure(config?: Options) {
  return function (tree: Node) {
    ...
    visit(
      ...
      (node: Element, index: number, parent: Parent) => {
        ...
        const figcaptionFirstChild = figcaptionElement.children[0] as Text;
        figcaptionFirstChild.value = cleanCaptionText(
